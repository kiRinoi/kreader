...
var list = function list(_list) {
    var status = window.getComputedStyle(_list, null).display;
    _list.style.display = status === 'none' ? 'block' : 'none';
    return;
};
...
var _readfile = __webpack_require__(12);
...
var _pageturn = __webpack_require__(11);

var _pageturn2 = _interopRequireDefault(_pageturn);

var _bookmark = __webpack_require__(9);
...
var book = function () {
    ...
    var setmark = document.querySelector('.setmark');
    var loadmark = document.querySelector('.loadmark');
    input.addEventListener('change', function () {
        localStorage.switch = 'false';
        var file = input.files;
        title.innerHTML = file[0].name.replace(/.txt/gi, '');
        title.style.color = '#888';
        _bookmark2.default.bookmark(setmark, title.innerHTML);
        _bookmark2.default.loadbookmark(loadmark);
        var turn = (0, _load2.default)(file[0].name, p);
        (0, _readfile2.default)(file, p, turn);
        (0, _pageturn2.default)(p, turn);
    });
}();
...
var readStyle = function () {
    function readStyle(bg, color, font, size, txt) {
        _classCallCheck(this, readStyle);
    ...
    _createClass(readStyle, [{
        ...
        key: 'changeColor',
        value: function changeColor(list) {
            var _this = this;
            ...
            try {
                var _loop = function _loop() {
                    ...
                    item.onclick = function () {
                        ...
                        _this.txt.style.background = window.getComputedStyle(item, null).backgroundColor;
        ...
        key: 'changeFont',
        value: function changeFont(list) {
            var font = void 0;
        ...
        key: 'changeSize',
        value: function changeSize(list) {
...
var setHeight = function setHeight(p) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/postcss-loader/index.js!./kstyle.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/postcss-loader/index.js!./kstyle.css");
...
var bookmark = function bookmark(btn, title) {
    var ul = document.querySelector('ul');
    var pre = document.querySelector('pre');
    if (!localStorage.li) localStorage.li = '<li>书签列表</li>';
    if (!localStorage.num) localStorage.num = 0;
    btn.onclick = function () {
        var page = 1 + Math.abs(Number(pre.style.left.replace(/px/gi, '')) / 800);
        localStorage.num++;
...
var loadbookmark = function loadbookmark(btn) {
    var ul = document.querySelector('ul');
    btn.onclick = function () {
        (0, _list2.default)(ul);
        ul.innerHTML = localStorage.li;
        ...
        try {
            var _loop = function _loop() {
                ...
                item.onclick = function () {
                    var span = item.querySelector('span').innerHTML;
                    var page = (Number(span) - 1) * 800;
...
var delMark = function () {
    var del = document.querySelector('.option > dt');
...
var load = function load(filename, p) {
	var turn = void 0;
...
var pageTurn = function pageTurn(p, turn) {
...
var readfile = function readfile(files, p, turn) {
	if (files.length) {
		var file = files[0];
...
var _setheight = __webpack_require__(6);

var _setheight2 = _interopRequireDefault(_setheight);

var _readstyle = __webpack_require__(5);
...
var toggle = function () {
    ...
    var readlist = document.querySelector('.readersetting');
    setting.addEventListener('click', function () {
        return (0, _list2.default)(readlist);
    });
}();

var setH = function () {
    var p = document.querySelector('pre');
    (0, _setheight2.default)(p);
}();

var txtStyle = function () {
    var body = document.querySelector('body');
    var bg = localStorage.background || '#faf9f3';
    var color = localStorage.color || '#333';
    var font = localStorage.font || '宋体';
    var size = localStorage.size || 16;
    var colorList = document.querySelectorAll('.color > dd');
    var fontList = document.querySelectorAll('.font > dd');
    var sizeList = document.querySelectorAll('.size > dd');
    var bookStyle = new _readstyle2.default(bg, color, font, size, body);
    bookStyle.loadStyle();
